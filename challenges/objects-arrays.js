...
console.log(tyrObject.weight);

// What was the diet of a velociraptor?
console.log(velObject.diet);

// How long was a stegosaurus?
console.log(stegObject.length);

// What time period did tyrannosaurus live in?
console.log(tyrObject.period);
...
*/
const populationTotal = zooAnimals.reduce((accumulator, arrItem) => {
  return accumulator + arrItem.population;
}, 0);
